                                ...
                                $.ajax({
                                    ...
                                    success: function (re) {
                                        ...
                                        if (re['code'] == "200") {
                                            ...
                                            $("#load").html("<font color='#2882e2'>"+left+"MB"+"</font>");
                                            if(re.data[0].time != undefined)
                                            $("#last_update").html("（最后更新："+re.data[0].time+"）").show();
                                        }else if(re['code'] == "500"){
                                            
                                            //location.href="/api/cardinfo/netbusy";
                                            $(".hea_div3").html("<div style='color:#FF4400;font-size:14px;text-align:center;padding:10px 0;'>网络繁忙，无法获取剩余流量</div>");
                                        }
                                    }
                                });
                            } else {
